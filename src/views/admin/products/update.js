...
export default function UpdateProduct() {
    ...
    const { uploadImages, deleteImage, isUploading, isDeleting } = useProductImages(productId);
    useEffect(() => {
        if (product) {
            reset({
                name: product.name,
