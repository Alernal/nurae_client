...
import { LuHeart, LuStar, LuShoppingBag, LuGem, LuSparkles } from "react-icons/lu"
...
const earrings = [
  {
    ...
    reviews: 18,
    isNew: false,
    description: "Aretes elegantes con cristales en tono malva",
  },
  {
    id: 6,
    ...
    reviews: 22,
    isNew: false,
    description: "Diseño geométrico moderno y sofisticado",
  },
  {
    id: 9,
    ...
    reviews: 15,
    isNew: true,
    description: "Aretes colgantes con cristales facetados",
  },
  {
    id: 10,
    name: "Aretes Perla Dorada",
    price: 145000,
    image: "/placeholder.svg?height=400&width=300",
    rating: 4.7,
    reviews: 28,
    isNew: true,
    description: "Combinación perfecta de perlas y oro",
  },
]
    ...
    <div>
      <div className="container px-4 py-8 md:px-6 md:py-12">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span>/</span>
          <span className="text-primary">Aretes</span>
        </div>
        ...
        <section className="relative py-16 md:py-20 mb-16 overflow-hidden">
          ...
          <div className="absolute top-10 left-10 text-pink-300 animate-float">
            <LuGem className="h-12 w-12" />
          </div>
          <div className="absolute bottom-10 right-10 text-purple-300 animate-float" style={{ animationDelay: "1s" }}>
          ...
          <div className="relative text-center space-y-8">
            <div className="inline-flex items-center gap-3 rounded-full bg-white/80 backdrop-blur-sm px-6 py-3 text-sm font-medium text-primary shadow-lg border border-pink-200">
              ...
              <span className="font-display">Colección Aretes</span>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
              Detalles que enmarcan tu belleza. Cada par de aretes está diseñado para realzar tu rostro y personalidad
              única.
            </p>
          </div>
        </section>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-primary font-medium uppercase">Aretes</span>
        ...
        <section className="mt-16 text-center space-y-8 bg-white/50 rounded-3xl p-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Cada rostro es único, por eso ofrecemos asesoría personalizada para encontrar los aretes perfectos para ti
          </p>
