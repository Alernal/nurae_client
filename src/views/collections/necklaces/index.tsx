...
import { LuHeart, LuStar, LuShoppingBag, LuCrown, LuSparkles } from "react-icons/lu"
...
const necklaces = [
  {
    ...
    reviews: 24,
    isNew: true,
    description: "Elegante collar de cadena con acabado en oro rosa",
  },
  {
    id: 5,
    ...
    reviews: 28,
    isNew: true,
    description: "Collar de perlas con diseño contemporáneo",
  },
  {
    id: 7,
    ...
    reviews: 22,
    isNew: false,
    description: "Choker elegante con diseño minimalista",
  },
  {
    id: 8,
    name: "Collar Colgante Cristal",
    price: 165000,
    image: "/placeholder.svg?height=400&width=300",
    rating: 4.9,
    reviews: 31,
    isNew: true,
    description: "Collar con colgante de cristal facetado",
  },
]
    ...
    <div>
      <div className="container px-4 py-8 md:px-6 md:py-12">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span>/</span>
          <span className="text-primary">Collares</span>
        </div>
        ...
        <section className="relative py-16 md:py-20 mb-16 overflow-hidden">
          ...
          <div className="relative text-center space-y-8">
            <div className="inline-flex items-center gap-3 rounded-full bg-white/80 backdrop-blur-sm px-6 py-3 text-sm font-medium text-primary shadow-lg border border-pink-200">
              ...
              <span className="font-display">Colección Collares</span>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
              Elegancia que abraza tu cuello. Descubre nuestra colección de collares únicos que complementan tu estilo
              personal.
            </p>
          </div>
        </section>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-primary font-medium uppercase">Collares</span>
        ...
        <section className="mt-16 text-center space-y-8 bg-white/50 rounded-3xl p-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explora toda nuestra colección o contáctanos para asesoría personalizada
          </p>
