    ...
    <div>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="absolute top-10 left-10 text-pink-300 animate-float">
          <LuMessageCircle className="h-12 w-12" />
        </div>
        ...
        <div className="container px-4 md:px-6 relative">
          <div className="text-center space-y-8">
            <div className="inline-flex items-center gap-3 rounded-full bg-white/80 backdrop-blur-sm px-6 py-3 text-sm font-medium text-primary shadow-lg border border-pink-200">
              ...
              <span className="font-display">Contáctanos</span>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-serif font-bold text-lg text-gray-800 mb-2">Dirección</h3>
                ...
                <div className="flex items-start gap-4 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-serif font-bold text-lg text-gray-800 mb-2">Teléfono</h3>
                    <p className="text-gray-600">
                      +52 55 1234 5678
                      <br />
                ...
                <div className="flex items-start gap-4 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-serif font-bold text-lg text-gray-800 mb-2">Email</h3>
                    <p className="text-gray-600">
                      hola@lumina.mx
                      <br />
                      soporte@lumina.mx
                ...
                <div className="flex items-start gap-4 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-serif font-bold text-lg text-gray-800 mb-2">Horarios de Atención</h3>
                    <p className="text-gray-600">
              ...
              <div className="p-6 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl">
                <h3 className="font-serif font-bold text-lg text-gray-800 mb-4">Síguenos en Redes Sociales</h3>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl">
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="h-12 rounded-xl border-2 border-pink-200 focus:border-primary"
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => handleInputChange("subject", value)}>
                      <SelectTrigger className="h-12 rounded-xl border-2 border-pink-200 focus:border-primary">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="min-h-32 rounded-xl border-2 border-pink-200 focus:border-primary resize-none"
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-luxury-gradient hover:opacity-90 text-white h-12 rounded-xl text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                ...
                <div className="text-center space-y-6 py-12">
                  ...
                  <h3 className="font-serif text-3xl font-bold text-gray-800">¡Mensaje Enviado!</h3>
                  <p className="text-lg text-gray-600 leading-relaxed">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {[
              ...
              >
                <h3 className="font-serif font-bold text-lg text-gray-800 mb-3">{faq.question}</h3>
