  ...
  return (
    <div className="container mx-auto p-6 space-y-8 text-gray-800">
      <h1 className="text-3xl font-bold mb-4">
        Política de Tratamiento de Datos Personales NÜRAE
      </h1>
      ...
      <section>
        ...
        <p>
          Los datos personales recolectados por NÜRAE serán utilizados para:
        </p>
      ...
      <section>
        ...
        <p>
          NÜRAE obtiene la autorización de los titulares mediante medios
      ...
      <section>
        ...
        <p>
          ...
          confidencialidad. NÜRAE cuenta con medidas técnicas, humanas y
      ...
      <section>
        ...
        <p>
          Los datos podrán ser compartidos con terceros que colaboren con NÜRAE
      ...
      <section>
        ...
        <p>
          NÜRAE podrá modificar esta política en cualquier momento. Las
      ...
      <p className="italic text-sm mt-4">
        Fecha de entrada en vigencia: {new Date().toLocaleDateString()}
      </p>

      <p className="text-center mt-6 font-medium">
        Con tu autorización, en NÜRAE tratamos tus datos con respeto, cuidado y
