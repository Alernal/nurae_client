export default function Terms() {
  return (
    <div className="bg-white">
      <div className="max-w-4xl text-justify mx-auto py-20 space-y-10 text-gray-800">
        ...
        <section>
          ...
          <p className="font-parrafo">
            Los datos personales recolectados por NURAE serán utilizados para:
          </p>
          <ul className="list-disc list-inside mt-2 space-y-1 font-parrafo">
        ...
        <section>
          ...
          <p className="font-parrafo">Los titulares de los datos personales tienen derecho a:</p>
          <ul className="list-disc list-inside font-parrafo mt-2 space-y-1">
        ...
        <section>
          ...
          <p className="font-parrafo">
            ...
            <a
              href="mailto:contacto@nurae.com.co"
