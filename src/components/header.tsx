...
import { LuSearch, LuHeart, LuMenu, LuCrown, LuSparkles, LuGift, LuPhone, LuMail, LuChevronDown } from "react-icons/lu"
...
const collections = [
  { name: "Collares", href: "/collections/necklaces", description: "Elegancia que abraza tu cuello" },
  { name: "Aretes", href: "/collections/earrings", description: "Detalles que enmarcan tu belleza" },
  { name: "Pulseras", href: "/collections/bracelets", description: "Sofisticación en cada movimiento" },
  { name: "Anillos", href: "/collections/rings", description: "Pequeñas obras de arte" },
]
      ...
      <div className="bg-luxury-gradient text-white py-2 px-4">
        <div className="container flex items-center justify-between text-sm">
          ...
          <div className="flex items-center gap-2 md:mx-0">
            ...
            <span className="font-medium">Envío gratis en compras mayores a $150.000 COP • Hasta 12 cuotas</span>
      ...
      <div className="container flex h-20 items-center justify-between px-4 md:px-6">
            ...
            <DropdownMenuContent className="w-80 bg-white/95 backdrop-blur-md border border-pink-100 shadow-xl rounded-2xl p-4">
              <div className="grid grid-cols-1 gap-2">
                <DropdownMenuItem asChild className="p-0">
                  ...
                  >
                    <span className="font-medium text-gray-800">Ver Todas las Colecciones</span>
                    <span className="text-sm text-gray-500">Explora nuestra colección completa</span>
                  </Link>
                </DropdownMenuItem>
                {collections.map((collection) => (
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="hover:bg-pink-50 hover:text-secondary transition-all duration-300 relative group"
          >
            <LuHeart className="h-5 w-5" />
            <span className="absolute -top-1 -right-1 h-5 w-5 bg-secondary text-white text-xs rounded-full flex items-center justify-center font-bold">
              3
            </span>
