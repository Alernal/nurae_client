    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="hover:bg-terra-warm/20 hover:text-primary transition-all duration-300 relative group"
        >
      ...
      <SheetContent className="w-full sm:max-w-lg bg-soft-gradient">
        <SheetHeader>
        ...
        <div className="flex flex-col h-full">
          {items.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center space-y-4">
              <LuShoppingBag className="h-16 w-16 text-secondary-300" />
              <h3 className="text-lg font-medium text-secondary-500">Tu carrito está vacío</h3>
              <p className="text-secondary-400">Agrega algunos productos para comenzar</p>
            ...
            <>
              <div className="flex-1 overflow-y-auto py-6 space-y-4">
                {items.map((item) => (
                  <div key={item.id} className="bg-white rounded-xl p-4 shadow-sm border border-terra-warm/30">
                    <div className="flex gap-4">
                      <div className="relative h-20 w-20 rounded-lg overflow-hidden bg-luxury-pearl">
                        <img src={item.image || "/placeholder.svg"} alt={item.name} className="object-cover" />
                      </div>
                      <div className="flex-1 space-y-2">
                        <h4 className="font-medium text-secondary-800 line-clamp-2">{item.name}</h4>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <Button
                              variant="outline"
                              size="icon"
                              className="h-8 w-8 border-terra-warm/50"
              ...
              <div className="border-t border-terra-warm/30 pt-4 space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    <span>Envío:</span>
                    <span className={shipping === 0 ? "text-terra-earth font-medium" : ""}>
                ...
                <div className="space-y-2">
                  ...
                  <Link to="/cart" onClick={() => setIsOpen(false)}>
                    <Button variant="outline" className="w-full border-terra-warm/50">
